...
<div class="grid1 grid-cols-2 w-10/12 mx-auto ">
    <!-- contact -->
    <div class="">
        <h1 class="text-4xl text-black mb-5s">Contact</h1>
        <p class="mb-5">Chúng tôi luôn trân trọng mọi ý kiến của quý khách, ý kiến từ quý khách sẽ giúp chúng tôi nâng cao về chất lượng phục vụ chính quý khách cũng góp phần vào sự thành công và phát triển thương hiệu Sun Homes BBQ của chúng tôi:</p>
        <p class="">Webdesign rất hoan nghênh độc giả gửi thông tin và góp ý cho chúng tôi!</p>
        <p class="">
            <b class="text-black text-xl">Địa chỉ</b> : Số 29 ngõ 18 Lương Ngọc Quyến, Hà Đông, Hà Nội.
        </p>
        <p class="">
            <b class="text-black text-xl">Email</b> : hoannvph28518@fpt.edu.vn
        </p>
        <p class="">
            <b class="text-black text-xl">SĐT</b> : 0384940225
        </p>
        <p class="">
            <b class="text-black text-xl">Website</b> : <a href="http://localhost/du_an_1">http://localhost/du_an_1</a>
        </p>
    </div>
    <form action="index.php?act=lienhe" method="post" class="mt-10 ml-10 flex flex-col gap-y-2">
        ...
        <!-- submit -->
        <input type="submit" name="submit" value="Gửi Liên Hệ" class="w-[200px] p-2 mt-2 bg-slate-200 border rounded-md hover:text-red-500 hover:bg-slate-100 border-black mb-7">
    </form>
</div>