...
<div class="w-3/12 flex-none">
    ...
    <nav class="">
        <ul>
            ...
            <li><a href="index.php?act=datmon" class="p-5 block bg-stone-100 hover:no-underline hover:bg-slate-200 <?php if ($act== "datmon") { echo $focus;}  ?> "><i class="fas fa-bell px-2" ></i>Đặt Món</a></li>
